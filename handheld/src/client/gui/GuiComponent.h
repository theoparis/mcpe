...
public:
  ...
  static bool drawTexturedQuad(float x, float y, float w, float h, float u0,
      float v0, float u1, float v1, int color = 0xffffffff);
  static bool drawQuad(float x, float y, float w, float h, int color);
...
protected:
  static bool tryDrawQuad(const GraphicsQuad &quad);
  static bool tryDrawTexturedQuad(
      GraphicsTexturedQuad quad, int color = 0xffffffff);
