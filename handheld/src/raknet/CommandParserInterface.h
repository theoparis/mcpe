...
int RAK_DLL_EXPORT RegisteredCommandComp(
...
public:
  ...
  virtual void SendHelp(
      TransportInterface *transport, const SystemAddress &systemAddress) = 0;
  ...
  virtual bool OnCommand(const char *command, unsigned numParameters,
      ...
      const SystemAddress &systemAddress, const char *originalString) = 0;
  ...
  static void ParseConsoleString(char *str, const char delineator,
      unsigned char delineatorToggle, unsigned *numParameters,
      char **parameterList, unsigned parameterListLength);
